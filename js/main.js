...
function drawGUI(parentDiv, data, course) {
    var grid = '<div class="panel panel-default"><div class="panel-heading"><h3 class="panel-title">Panel title</h3></div><div class="panel-body"><div id="left"></div><div id="right"></div></div>';
